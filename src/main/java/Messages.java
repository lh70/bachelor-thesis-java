...
public class Messages {
     ...
     */
    public static String getAssignmentMessage(String sensorKind) {
        return "{\n" +
     ...
     * @return the json encoded message string
     */
    public static String getRemoveAssignmentMessage() {
        return "{\n" +
                "  \"remove-assignment\": {\n" +
                "    \"assignment-id\": \"0\"\n" +
                "  }\n" +
     ...
     * @return the json encoded message string
     */
    public static String getPipelineRequestMessage() {
        return "{\n" +
                "  \"pipeline-request\": {\n" +
                "    \"assignment-id\": \"0\",\n" +
                "    \"pipe-id\": \"0\",\n" +
